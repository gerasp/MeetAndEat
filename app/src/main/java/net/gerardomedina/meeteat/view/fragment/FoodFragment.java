...
import net.gerardomedina.meeteat.task.GetFoodTask;
import net.gerardomedina.meeteat.view.activity.LocationActivity;
import net.gerardomedina.meeteat.view.activity.MainActivity;
import net.gerardomedina.meeteat.view.dialog.AddFoodDialog;
import net.gerardomedina.meeteat.view.dialog.OptionsDialog;
import net.gerardomedina.meeteat.view.dialog.ParticipantsDialog;
import net.gerardomedina.meeteat.view.table.FoodAdapter;
import net.gerardomedina.meeteat.view.table.SortableFoodTableView;
