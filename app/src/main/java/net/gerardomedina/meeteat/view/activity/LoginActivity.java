...
import net.gerardomedina.meeteat.task.LoginTask;
import net.gerardomedina.meeteat.task.RememberPasswordTask;
import net.gerardomedina.meeteat.task.SignupTask;
